...
echo_and_run cd "/home/pierremoussa/catkin_ws/src/iROS_drone/rotors_simulator/rotors_evaluation"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/pierremoussa/catkin_ws/src/iROS_drone/rotors_simulator/rotors_evaluation/setup.py" \
     \
    build --build-base "/home/pierremoussa/catkin_ws/build/iROS_drone/rotors_simulator/rotors_evaluation" \
    install \
    --root="${DESTDIR-/}" \
